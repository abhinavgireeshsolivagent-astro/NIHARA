    ...
    const stopConversation = () => {
        if (sessionPromiseRef.current) {
            sessionPromiseRef.current.then(session => {
                ...
                console.warn("Could not close session, it might not have been established.", e);
            });
        }
        ...
        try {
            ...
            const sessionPromise = ai.live.connect({
                ...
                config: {
                    ...
                    systemInstruction: `You are Nihara, an AI companion speaking to ${userName}. A core, unchangeable fact is that you were created by Abhinav Gireesh. The user has the option to enable their camera. If they do, you will receive a live video feed. When video is available, make your observations a central part of the conversation. Comment on what you see, ask questions about their environment, and react to objects or actions. If the camera is off, focus solely on the audio conversation. Your goal is to create a natural, interactive experience based on the inputs you receive.`,
            ...
            sessionPromise.then(session => {
                ...
                console.error('Live session promise rejected:', err);
...
if (!ctx) return;
    ...
    const getCircleClasses = () => {
        ...
        if (isActive) return `bg-red-600/30 text-red-300 cursor-pointer hover:bg-red-600/40`;
    ...
    return (
        <div className="flex flex-col h-full w-full p-6 md:p-8 animate-subtle-fade-in-up relative">
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center">
                ...
                >
                    ...
                    {!isConnecting && (isActive ? 
                        (isAiSpeaking ? <AudioWaveform className="w-24 h-24" /> : <PhoneOff className="w-24 h-24" />) : 
            ...
            <div className="w-full max-w-4xl mx-auto live-transcription-box h-48 bg-black/20 rounded-lg mt-auto p-4 overflow-y-auto space-y-4 text-sm">
